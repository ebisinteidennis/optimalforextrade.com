...
<div class="panel-body" style="background-color:#121629; color:#86889a">
    <p align="center" style="color:#fff"><B>WITHDRAW</B></p>
...
<form method="post" action="pwithdraw.php" class="form-horizontal">
                                                    ...
                                                    <div class="form-body pal">
                                <div class="form-group"><label for="inputEmail" class="col-md-3 control-label">Withdraw Process <span class='require'>*</span></label>


                                                                                           <div class="form-group col-md-3">
                                               <select name='paymentmethod' class="form-control input-md" required><option value='' selected='selected'></option><option value='Bitcoin' >Bitcoin</option><option value='Litecoin' >
                                                   Litcoin</option>
                                                <option value='Etherum' >Etherum</option><option value='stellar' >Stellar</option>
                                                <option value='Western Union' >Western Union</option>
                                                 <option value='Bank Transfer' >Bank Transfer</option>
                                                 <option value='Skrill' >Skrill</option><option value='Paypal' >Paypal</option>
                                                       ...
                                                       <div class="form-actions">
                                                        <div class="col-md-offset-3 col-md-9">
                                                            <a href="pwithdraw.php">
                                                                <button type="button" class="" style="background-color:#0094fe;color:#fff; padding:5px 10px"><b>MAKE WITHDRAWAL</b></button>
                                                            </a>
                                                            &nbsp;
                                                        </div>
                                                    </div>
