...
<body>
 ...
 <section style="background-color:#121629; color:#fff">   
...
<script src="//code.tidio.co/3g9uo64zn90geprvtzm2tu4edr2tyslo.js" async></script>
...
<a href="changeavatar.php">Upload a Profile Picture</a>
  <a class="active" href="https://Globalbitasset.com"><i class="fa fa-fw fa-home"></i> Home</a> 
...
margin: 5 0 20 0;
 ...
 height: 50px;
  ...
  <div><a href="index.php"><img src="../img/logo2.png" width="190"> </a></div>
   <li>      
...
<div class="row" >
<div class="col-lg-12"  style="background-color:#121629;">
...
<div class="col-lg-12" style="background-color:#121629; color:#fff">
                                        ...
                                        <div class="panel panel-red" style="background-color:#121629; color:#fff">
                                            <div class="panel-heading">DEPOSIT History</div>
...
<div>
  <form action="/action_page.php" align="center">
    ...
    <center>Copy and send the exact bitcoin equivalent of your selected plan to the bitcoin address below;</center>
  <b>  <input type="text" id="country" name="btcdeposit" align="center" value=""readonly/></b>
  <center>Once we confirm your payment your account will be funded instantly</center>
  </form>
</div>
                                            ...
                                            <div class="panel-heading" align="center"><b>Transfer Confirmation</b></div>
                                            <div class="panel-body">
...
<input type="hidden" class="form-control" name="username" value="cagda" />
<input type="hidden" class="form-control" name="userph" value="<br />
<b>Notice</b>:  Undefined variable: qx in <b>/home/globwbyo/public_html/account/user/payment.php</b> on line <b>421</b><br />
" />
<input type="hidden" class="form-control" name="idb" value="<br />
<b>Notice</b>:  Undefined variable: qx in <b>/home/globwbyo/public_html/account/user/payment.php</b> on line <b>422</b><br />
" />
<input type="hidden" class="form-control" name="idph" value="<br />
<b>Notice</b>:  Undefined variable: qx in <b>/home/globwbyo/public_html/account/user/payment.php</b> on line <b>423</b><br />
" />
<input type="hidden" class="form-control" name="usergh" value="<br />
<b>Notice</b>:  Undefined variable: qxq in <b>/home/globwbyo/public_html/account/user/payment.php</b> on line <b>424</b><br />
" />
<input type="hidden" class="form-control" name="idj" value="<br />
<b>Notice</b>:  Undefined variable: qxq in <b>/home/globwbyo/public_html/account/user/payment.php</b> on line <b>425</b><br />
" />
<input type="hidden" class="form-control" name="idgh" value="<br />
<b>Notice</b>:  Undefined variable: qx in <b>/home/globwbyo/public_html/account/user/payment.php</b> on line <b>426</b><br />
" />
 ...
 <div class="form-group"><label for="username" class="control-label col-md-3">Upload Picture</label>
                    ...
                    <p class="help-block">Only jpg,jpeg,png and gif file with maximum size of 2MB is allowed.</p></div>
                                        </div>
 

<div class="form-group"><label for="username" class="control-label col-md-3">Your Message</label>
...
<br>
                                                <button type="submit" name="submit" class="btn btn-" style="background-color:#089ad3;color:#fff">Send Transfer Confirmation</button>
                                            </div>
                                        </div>
                                    </form>
