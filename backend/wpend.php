...
<ul>
  <li><i class='fa fa-spinner fa-spin fa-2x fa-fw'></i>
<span class='sr-only'>Loading...</span>Transaction in progress...<span class='close'>&times;</span></li>
</ul>
...
<center><a href="index.php" align="center" style="color:#0094fe"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i>Return to dashboard</a></center>
