...
<form method="post" action="deposit" class="form-horizontal">
...
.btn {
  ...
  cursor: pointer;
                  ...
                  <a href="deposits.php" >    <p class="btn" style="background-color:#18d39f"><i class="fa fa-plus-circle" aria-hidden="true"></i> New Deposit</p>
                </a> 
...
<div class="col-lg-12">
                                        ...
                                        <div class="panel panel-red" style="background-color:#121629; color:#86889a">
                                            <div class="panel-heading">DEPOSIT HISTORY</div><p class="panel-heading">    <div class="panel-body">
...
<div class="panel-body" style="background-color:#121629; color:#18d39f">
...
<form method="post" action="withdraw" class="form-horizontal">
  ...
  cursor: pointer;
                                                       ...
                                                       <div class="form-actions">
                                                        <div class="col-md-offset-3 col-md-9">
                                                           <a href="withdraws.php" >    <p class="btn"><i class="fa fa-plus-circle" aria-hidden="true"></i> New Withdraw</p>
                </a> 
...
<tr>
 ...
 <th><center>ID</center></th>
                                                ...
                                                <th><center>Amount</center></th>                                               
<th><center>Withdraw Method</center></th>    
