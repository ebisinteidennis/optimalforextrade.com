                        ...
                        <div class="new-arrival-product">
                            <form method="POST" action="">
	                            <div class="new-arrival-content text-center mt-0">
	                                ...
	                                <p><i class="pe-7s-play"></i> Plan Minimum Amount - <b>$<?php echo $ct ?><?php echo $row['min_amt'];?></b></p>
                                  <p><i class="pe-7s-play"></i> Plan maximum Amount - <b>$<?php echo $ct ?><?php echo $row['max_amt'];?></b></p>
